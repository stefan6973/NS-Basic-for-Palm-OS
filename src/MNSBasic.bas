...
Public Function getThemeColors(filename) As Long()
   ...
   '~~~~~~~~~~~~~~~~~~~~
   traceMsg "getThemeColors 1" & filename
   '~~~~~~~~~~~~~~~~~~~~
   ...
   '~~~~~~~~~~~~~~~~~~~~
   traceMsg "getThemeColors 2" & GetAbsolutePath(filename, "")
   '~~~~~~~~~~~~~~~~~~~~

   '~~~~~~~~~~~~~~~~~~~~
   traceMsg "getThemeColors filedirectory=" & fileDirectory
   '~~~~~~~~~~~~~~~~~~~~

   On Error GoTo themeNotFound
   Open GetAbsolutePath(filename, "") For Input As #1
   On Error GoTo 0
   Close #nFileNumber
   
   Open GetAbsolutePath(filename, "") For Binary Access Read As #1
   Get #1, 89, themeResource
   Close #1
   
   '~~~~~~~~~~~~~~~~~~~~
   traceMsg "getThemeColors 3" & filename
   '~~~~~~~~~~~~~~~~~~~~
...
themeNotFound:
   '~~~~~~~~~~~~~~~~~~~~
   traceMsg "getThemeColors 4" & filename
   '~~~~~~~~~~~~~~~~~~~~
